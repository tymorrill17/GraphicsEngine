...
public:
    ...
    inline virtual VkImage image() { return _image; }
    inline virtual VkImageView imageView() { return _imageView; }
    inline virtual VkImageLayout imageLayout() { return _imageLayout; }
    inline virtual VkExtent3D extent() { return _extent; }
    inline virtual VkFormat format() { return _format; }
...
public:
	...
	AllocatedImage(Device& device, Allocator& allocator,
