...
class Command {
public:
	Command(Device& device, VkCommandPoolCreateFlags flags); // Create a command pool alongside command buffer creation
    ...
    inline std::shared_ptr<CommandPool> pool() { return _commandPool; }
